!function (n) {
    ...
    var e, n, r, i, h, o, s, f, g, m, v, y, _, a, l, b,
        c = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (e = t.fn.select2.amd), e && e.requirejs || (e ? r = e : e = {}, m = {}, v = {}, y = {}, _ = {}, a = Object.prototype.hasOwnProperty, l = [].slice, b = /\.js$/, f = function (e, t) {
            ...
            var i, o, s, a, l, c, u = [], d = typeof n, p = D(r = r || e);
            if ("undefined" == d || "function" == d) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0; l < t.length; l += 1) if ("require" === (o = (a = f(t[l], p)).f)) u[l] = g.require(e); else if ("exports" === o) u[l] = g.exports(e), c = !0; else if ("module" === o) i = u[l] = g.module(e); else if (w(m, o) || w(v, o) || w(_, o)) u[l] = x(o); else {
                ...
                s = n ? n.apply(m[e], u) : void 0, e && (i && i.exports !== h && i.exports !== m[e] ? m[e] = i.exports : s === h && c || (m[e] = s))
            } else e && (m[e] = n)
        ...
        }).amd = {jQuery: !0}, e.requirejs = n, e.require = r, e.define = i), e.define("almond", function () {
            ...
            return f.Extend(r, f.Observable), r.prototype.render = function () {
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    var e, t = l.getHighlightedResults();
                    0 !== t.length && (e = f.GetData(t[0], "data"), "true" == t.attr("aria-selected") ? l.trigger("close", {}) : l.trigger("select", {data: e}))
                }), t.on("results:previous", function () {
                    var e, t, n, r, i, o = l.getHighlightedResults(), s = l.$results.find("[aria-selected]"),
                        a = s.index(o);
                    ...
                    var e, t, n, r, i = l.getHighlightedResults(), o = l.$results.find("[aria-selected]"),
                        s = o.index(i) + 1;
                ...
                var e, t, n, r, i, o = this.getHighlightedResults();
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var n, r;
                e.call(this, t), 0 < this.$selection.find(".select2-selection__placeholder").length || 0 === t.length || (n = this.options.get("translations").get("removeAllItems"), r = i('<span class="select2-selection__clear" title="' + n() + '">&times;</span>'), a.StoreData(r[0], "data", t), this.$selection.find(".select2-selection__rendered").prepend(r))
            }, e
            ...
            return e.prototype.render = function (e) {
                ...
                e.call(this, t, n), t.on("open", function () {
                    ...
                    var t, n;
                    e.stopPropagation(), r.trigger("keypress", e), r._keyUpPrevented = e.isDefaultPrevented(), e.which === l.BACKSPACE && "" === r.$search.val() && 0 < (t = r.$searchContainer.prev(".select2-selection__choice")).length && (n = a.GetData(t[0], "data"), r.searchRemoveChoice(n), e.preventDefault())
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                e.call(this, t, n), t.on("*", function (e, t) {
                    var n;
                    -1 !== s.inArray(e, i) && (t = t || {}, n = s.Event("select2:" + e, {params: t}), r.$element.trigger(n), -1 !== s.inArray(e, o) && (t.prevented = n.isDefaultPrevented()))
                })
            }, e
            ...
            return h.Extend(r, e), r.prototype.bind = function (e, t) {
                ...
                for (var t = this, n = this.$element.find("option"), r = n.map(function () {
                    ...
                    var s, a, l, c, u, d, p = this._normalizeItem(e[o]);
            ...
            return e.prototype.query = function (e, c, u) {
                ...
                this._removeOldTags(), null != c.term && null == c.page ? e.call(this, c, function e(t, n) {
                    ...
                    null != l && ((a = d.option(l)).attr("data-select2-tag", !0), d.addOptions([a]), d.insertTag(r, l)), t.results = r, u(t)
                }) : e.call(this, c, u)
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var i = this.tokenizer(t, this.options, function (e) {
                    ...
                    }).length || ((t = r.option(n)).attr("data-select2-tag", !0), r._removeOldTags(), r.addOptions([t])), r.trigger("select", {data: n})
                });
                ...
                for (var i = n.get("tokenSeparators") || [], o = t.term, s = 0, a = this.createTag || function (e) {
                    ...
                    var l, c, u = o[s];
                    -1 !== d.inArray(u, i) ? (l = o.substr(0, s), null != (c = a(d.extend({}, t, {term: l}))) ? (r(c), o = o.substr(s + 1) || "", s = 0) : s++) : s++
                }
                return {term: o}
            }, e
            ...
            return e.prototype.append = function (e, t) {
                ...
                var e, t = n.contains(document.documentElement, this.$loadingMore[0]);
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var r, i = this.getHighlightedResults();
                i.length < 1 || null != (r = o.GetData(i[0], "data")).element && r.element.selected || null == r.element && r.selected || this.trigger("select", {data: r})
            }, e
            ...
            return n.prototype.apply = function (e) {
                ...
                for (var t, n = c.isArray(e) ? e : [e], r = [], i = 0; i < n.length; i++) r.push(n[i]), "string" == typeof n[i] && 0 < n[i].indexOf("-") && (t = n[i].split("-")[0], r.push(t));
                return r
            ...
            function e(e, t) {
                var n;
                this.options = e, null != t && this.fromElement(t), null != t && (this.options = i.applyFromElement(this.options, t)), this.options = i.apply(this.options), t && t.is("input") && (n = r(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = p.Decorate(this.options.dataAdapter, n))
            }
            ...
            return e.prototype.fromElement = function (e) {
                ...
                for (var i = 0; i < e[0].attributes.length; i++) {
                    var o, s, a = e[0].attributes[i].name, l = "data-";
            ...
            return u.Extend(d, u.Observable), d.prototype._generateId = function (e) {
                ...
                if (!e || !e.target || "OPTION" === e.target.nodeName || "OPTGROUP" === e.target.nodeName) {
                    if (t) if (t.addedNodes && 0 < t.addedNodes.length) for (var i = 0; i < t.addedNodes.length; i++) t.addedNodes[i].selected && (n = !0); else t.removedNodes && 0 < t.removedNodes.length ? n = !0 : o.isArray(t) && o.each(t, function (e, t) {
        ...
        }), {define: e.define, require: e.require}), u = c.require("jquery.select2");
    ...
    function x(e) {
        var t;
        if (w(v, e) && (t = v[e], delete v[e], _[e] = !0, o.apply(h, t)), !w(m, e) && !w(_, e)) throw new Error("No " + e);
        return m[e]
    }
